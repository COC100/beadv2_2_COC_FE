...
export const OAUTH_CONFIG = {
  kakao: {
    ...
    // Frontend callback page that will handle the OAuth callback
    redirectUri: `${FRONTEND_URL}/login/oauth2/code/kakao`,
  ...
  google: {
    ...
    // Frontend callback page that will handle the OAuth callback
    redirectUri: `${FRONTEND_URL}/login/oauth2/code/google`,
  ...
  naver: {
    ...
    // Frontend callback page that will handle the OAuth callback
    redirectUri: `${FRONTEND_URL}/login/oauth2/code/naver`,
